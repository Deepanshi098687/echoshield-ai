        ...
        <section class="dashboard-grid row gx-4 gy-4">
            ...
            <div class="col-xl-12">
                <div class="panel glass-panel result-panel">
                    ...
                    <div class="result-cards">
                        <article class="result-card result-card--glow">
                            <span>AI engine</span>
            ...
            <div class="col-xl-12" id="wellness">
                <div class="panel glass-panel protection-panel">
                    ...
                    <div class="row gx-3 gy-3">
                        <article class="col-sm-6 col-lg-4 protection-card protection-card--green">
                            <span>Your Active Cases</span>
                            <strong><?php echo (int) $stats['active_cases']; ?></strong>
                        </article>
                        <article class="col-sm-6 col-lg-4 protection-card protection-card--purple">
                            <span>Reported Incidents</span>
                            <strong><?php echo (int) $stats['total_reports']; ?></strong>
                        </article>
                        <article class="col-sm-6 col-lg-4 protection-card protection-card--red">
